...
if os.environ.get("DAILY_VT","0") == "1":
  try:
    ...
    try:
        ...
        _vda = Vd_a.dropna(); _tda = Td_a.reindex(_vda.index)
        ...
        with open("nowcast_export.json", "w", encoding="utf-8") as f:
            json.dump({"note": "seal-on-1st study: S&P-aligned daily nowcast + monthly-gauge intermediates",
                       "monthly_gauge": monthly, "daily_nowcast": daily}, f)
